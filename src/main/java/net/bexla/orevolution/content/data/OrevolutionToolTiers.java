...
public enum OrevolutionToolTiers implements Tier {
    TIN(1, 256, 5F, 1F, 7, () -> Ingredient.of(RegItems.TIN_INGOT.get()), OrevolutionTags.Blocks.needsTinTool),
    PLATINUM(2,768,7F,2F,11, () -> Ingredient.of(RegItems.PLATINUM_INGOT.get()), OrevolutionTags.Blocks.needsPlatinumTool),
    ...
    LIVINGSTONE(1, 192, 4F, 1F, 8, () -> Ingredient.of(RegItems.LIVINGSTONE_SHARD.get()), OrevolutionTags.Blocks.needsTinTool),
    VERDITE(2, 448, 6F, 2F, 16, () -> Ingredient.of(RegItems.VERDITE_INGOT.get()), OrevolutionTags.Blocks.needsPlatinumTool);
