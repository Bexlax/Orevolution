...
public class ArmorCauseMultipleEffectsOnAttacked extends OrevolutionArmorPower {
    private final List<MobEffect> effectsWearer;
    private final List<MobEffect> effectsAttacker;
    private final int duration;
    private final int amplifier;

    public ArmorCauseMultipleEffectsOnAttacked(String tooltipId, Conditional conditional, int duration, int amplifier, List<MobEffect> effectsWearer, List<MobEffect> effectsAttacker) {
