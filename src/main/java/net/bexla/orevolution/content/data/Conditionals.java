...
public class Conditionals {
     ...
     */
    @Contract(pure = true)
    public static @NotNull IConditional targetMobType(MobType type) {
     ...
     */
    @Contract(pure = true)
    public static @NotNull IConditional isSubmergedInLiquid(TagKey<Fluid> fluidTag) {
     ...
     */
    @Contract(pure = true)
    public static @NotNull IConditional toolHasEnchantment(Enchantment enchantment) {
