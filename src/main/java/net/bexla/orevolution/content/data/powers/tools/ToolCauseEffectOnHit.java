...
public class ToolCauseEffectOnHit extends ToolCauseMultipleEffectsOnHit {
    public ToolCauseEffectOnHit(String tooltip_target_id, String tooltip_attacker_id, IConditional conditional, int duration, int amplifier, Supplier<MobEffect> effectTarget, Supplier<MobEffect> effectAttacker) {
