...
public class OrevolutionPickaxe extends PickaxeItem {
    private final OrevolutionToolMaterial material;

    public OrevolutionPickaxe(OrevolutionToolMaterial material, int damage, float speed, Properties properties) {
