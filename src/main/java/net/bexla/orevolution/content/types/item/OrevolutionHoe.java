...
public class OrevolutionHoe extends HoeItem {
    private final OrevolutionToolMaterial material;

    public OrevolutionHoe(OrevolutionToolMaterial material, float speed, Properties properties) {
        super(material.getTier(), 1, speed, properties);
