...
public class AethersteelChestplate extends ArmorItem {
    public AethersteelChestplate(ArmorMaterial mat, Type type, Properties properties) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return slot == EquipmentSlot.CHEST ? AethersteelChestplateModel.LAYER_LOCATION : super.getArmorTexture(stack, entity, slot, type);
    }
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(
                ...
                if (slot == EquipmentSlot.CHEST) {
                    return new AethersteelChestplateModel<>(AethersteelChestplateModel.createBodyLayer().bakeRoot());
                }
                return original;
            }
        });
