...
public class GENBlockTags extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(OrevolutionTags.Blocks.spelunkeryOres).addOptional(modLocat("tin_ore_andesite")).addOptional(modLocat("tin_ore_diorite"))
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(RegBlocks.TIN_ORE.get()).add(RegBlocks.PLATINUM_ORE.get()).add(RegBlocks.NETHER_TUNGSTEN_ORE.get())
                ...
                .add(RegBlocks.POLISHED_AETHERROCK_WALL.get()).add(RegBlocks.POLISHED_AETHERROCK_SLAB.get()).addOptionalTag(modLocat("spelunkery/ores"));
        ...
        tag(OrevolutionTags.Blocks.uncommonDuplicateChance).addTags(
                ...
                BlockTags.ANVIL,
                Tags.Blocks.GRAVEL);
        tag(OrevolutionTags.Blocks.rareDuplicateChance).addTag(Tags.Blocks.STORAGE_BLOCKS);
        ...
        tag(OrevolutionTags.Blocks.stoneTiered).add(Blocks.IRON_BLOCK).add(Blocks.IRON_ORE).add(Blocks.DEEPSLATE_IRON_ORE).add(Blocks.RAW_IRON_BLOCK)
                .add(Blocks.IRON_BARS).add(Blocks.IRON_DOOR).add(Blocks.IRON_TRAPDOOR).add(Blocks.HOPPER)
                .addTag(BlockTags.ANVIL).addTag(OrevolutionTags.Blocks.tinTiered);

        tag(OrevolutionTags.Blocks.tinTiered).add(RegBlocks.VERDITE_BLOCK.get()).add(RegBlocks.PLATINUM_ORE.get()).add(RegBlocks.DEEPSLATE_PLATINUM_ORE.get()).
                ...
                addTag(OrevolutionTags.Blocks.ironTiered);

        tag(OrevolutionTags.Blocks.ironTiered).add(Blocks.DIAMOND_BLOCK).add(Blocks.DIAMOND_ORE).add(Blocks.DEEPSLATE_DIAMOND_ORE)
                .add(Blocks.REDSTONE_BLOCK).add(Blocks.REDSTONE_ORE).add(Blocks.DEEPSLATE_REDSTONE_ORE).addTag(OrevolutionTags.Blocks.platTiered);

        tag(OrevolutionTags.Blocks.platTiered).add(RegBlocks.NETHER_TUNGSTEN_ORE.get()).add(RegBlocks.RAW_TUNGSTEN_BLOCK.get()).add(RegBlocks.END_XP_ORE.get())
                .add(RegBlocks.TUNGSTEN_BLOCK.get()).addTag(OrevolutionTags.Blocks.diamondTiered);

        tag(OrevolutionTags.Blocks.diamondTiered).add(RegBlocks.PRIMITIVE_AETHERROCK.get()).add(RegBlocks.AETHERSTEEL_BLOCK.get());
