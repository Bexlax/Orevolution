...
public class RegItems {
    ...
    //~//~~Armors, Tools and Weapons~~//~//
        /*Tin set*/
    public static final RegistryObject<Item> TIN_SWORD = HELPER.createItem("tin_sword", () -> new SwordItem(net.bexla.orevolution.content.data.utility.OrevolutionToolTiers.TIN, 3, -2.4f, new Item.Properties()));
    ...
    public static final RegistryObject<Item> AETHERSTEEL_SWORD = HELPER.createItem("aethersteel_sword", () -> new SwordItem(OrevolutionToolTiers.AETHERSTEEL, 3, -2.4f, new Item.Properties()));
    public static final RegistryObject<Item> AETHERSTEEL_PICKAXE = HELPER.createItem("aethersteel_pickaxe", () -> new PickaxeItem(OrevolutionToolTiers.AETHERSTEEL, 1, -2.6f, new Item.Properties()));
    public static final RegistryObject<Item> AETHERSTEEL_AXE = HELPER.createItem("aethersteel_axe", () -> new AxeItem(OrevolutionToolTiers.AETHERSTEEL, 5F, -2.2f, new Item.Properties()));
    public static final RegistryObject<Item> AETHERSTEEL_SHOVEL = HELPER.createItem("aethersteel_shovel", () -> new ShovelItem(OrevolutionToolTiers.AETHERSTEEL, 1.5f, -3f, new Item.Properties()));
    public static final RegistryObject<Item> AETHERSTEEL_HOE = HELPER.createItem("aethersteel_hoe", () -> new HoeItem(OrevolutionToolTiers.AETHERSTEEL, 1, -2f, new Item.Properties()));
        /*Livingstone set*/
